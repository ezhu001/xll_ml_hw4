...
AddIn xai_option_bsm_put(
	...
	.Arguments({
		...
		.Category(CATEGORY)
	.FunctionHelp(L"Return price of a European put option under the BSM parameterization.")
);
